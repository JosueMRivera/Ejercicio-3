...
namespace Datos
{
    public class ProductoDB
    {
        ...
        public Productos DevolverProductosPorCodigo(string codigo)
        {
                ...
                using (MySqlConnection _Conexion = new MySqlConnection(cadena))
                {
                    ...
                    using (MySqlCommand comando = new MySqlCommand(sql.ToString(), _Conexion))
                    {
                        ...
                        if (dr.Read())
                        {
                            ...
                            productos.Existencia = Convert.ToInt32(dr["Existencia"]);
                            productos.Precio = Convert.ToDecimal(dr["Precio"]);
                            productos.EstaActivo = Convert.ToBoolean(dr["EstaActivo"]);
                        }
                    }
                }
            }
